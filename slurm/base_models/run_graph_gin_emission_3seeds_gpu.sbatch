#!/bin/bash
#SBATCH --job-name=gin_em_3seed
#SBATCH --partition=gpubase_bygpu_b2
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --gpus-per-node=h100:1
#SBATCH --output=outputs/slurm/graph_gin_emission_3seeds_gpu_%j.out
#SBATCH --error=outputs/slurm/graph_gin_emission_3seeds_gpu_%j.err
...
mkdir -p models/graph_gin_emission_3seeds_gpu
mkdir -p outputs/graph_gin_emission_3seeds_gpu
...
echo "Graph GIN emission 3-seed GPU job started on $(hostname)"
...
for SEED in 0 1 2; do
  echo "============================================================"
  echo "Running graph_gin emission_nm seed ${SEED}"
  echo "Seed start time: $(date)"
  echo "============================================================"

  mkdir -p models/graph_gin_emission_3seeds_gpu/seed_${SEED}
  mkdir -p outputs/graph_gin_emission_3seeds_gpu/seed_${SEED}
  ...
  echo "Finished graph_gin emission_nm seed ${SEED} at $(date)"
done

echo "End time: $(date)"
echo "Graph GIN emission 3-seed GPU job completed."

echo "Seed outputs:"
find outputs/graph_gin_emission_3seeds_gpu -maxdepth 2 -type f | sort
